...
class EditableField extends React.Component {
  render() {
    return (
      <div className="form-group bg-light my-1 flex-nowrap">
        {
          this.props.cellData.leading != null &&
          <div className="form-group bg-light fw-bold border-0 text-secondary px-2">
        ...
        <input className={`form-control bg-light ${this.props.cellData.textAlign}`}
